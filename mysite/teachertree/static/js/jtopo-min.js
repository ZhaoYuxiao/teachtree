...
function(JTopo) {
    ...
    function toJson(a) {
        ...
        c = "text,elementType,x,y,width,height,visible,alpha,rotate,scaleX,scaleY,fillColor,shadow,transformAble,zIndex,dragable,selected,showSelected,font,fontColor,textPosition,textOffsetX,textOffsetY,idPosition,idFather".split(","),
        d = "{";
        d += "frames:" + a.frames,
        d += ", scenes:[";
